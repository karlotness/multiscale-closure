...
class BaseStackedGZFCNNV2(eqx.Module):
    seq: collections.abc.Sequence[eqx.Module]
    img_size: int = eqx.field(static=True)
    n_layers_in: int = eqx.field(static=True)
    n_layers_out: int = eqx.field(static=True)
...
def StackedGZFCNNV2(img_size, n_layers_in, n_layers_out, depth, padding="circular", normalization=None, zero_mean=False, *, key):
    return BaseStackedGZFCNNV2(
        img_size=img_size,
        n_layers_in=n_layers_in,
        n_layers_out=n_layers_out,
        depth=depth,
...
def MediumStackedGZFCNNV2(img_size, n_layers_in, n_layers_out, depth, padding="circular", normalization=None, zero_mean=False, *, key):
    return BaseStackedGZFCNNV2(
        img_size=img_size,
        n_layers_in=n_layers_in,
        n_layers_out=n_layers_out,
