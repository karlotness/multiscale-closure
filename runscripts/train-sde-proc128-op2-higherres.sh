...
#SBATCH --job-name=train-sde-proc128-op2-higherres
...
# Constants
readonly BASE_NAME="train-sde-proc128-op2-higherres"
...
readonly TRAIN_DATA_DIR="${SCRATCH}/closure/data/train/op2/"
readonly VAL_DATA_DIR="${SCRATCH}/closure/data/val/op2/"
